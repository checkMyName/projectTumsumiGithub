...
import { switchFunctional } from '../components/switchFunctional';
import { addressesMap } from '../components/addressesMap';
import { specItemReadMore } from '../components/specItemReadMore';
import { chapterSlider } from '../components/chapterSlider';
import { imageZoom } from '../components/imageZoom';
import { searchDropdown } from '../components/searchDropdown';
import { addFile } from '../components/addFile';
import { calendarFunctional } from '../components/calendarFunctional';
	...
	init() {
		try {
			this
				...
				.addComponent(tripledot)
				.addComponent(dropdownPopup)
				.addComponent(switchFunctional)
				.addComponent(chapterSlider)
				.addComponent(addressesMap)
				.addComponent(specItemReadMore)
				.addComponent(imageZoom)
				.addComponent(searchDropdown)
				.addComponent(searchHighlight)
				.addComponent(addFile)
				.addComponent(calendarFunctional)
