...
const { xxl, xl, lg, md, sm } = variables.breakpoints

const sliderSelector = '.js-specialists-slider';
const sliderButtonPrevSelector = '.js-slider-button-prev';
const sliderButtonNextSelector = '.js-slider-button-next';
const sliderPaginationSlider = '.js-slider-pagination';

export function specialistsSlider() {

  return new Component({
    name: 'specialistsSlider',
